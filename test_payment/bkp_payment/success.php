...
if($paymentstatus=='SUCCESS'){
 // echo 'sdcd'; die;
  // $myQuerys="UPDATE `payment` SET `TransactionStatus`='".$getData['payment_status']."',`TransactionTime`='".$getData['payment_time']."',`callback_response`='".$getData['callback_response']."' where `order_id`='".$order_id."'";
  // if ($con->query($myQuerys) === TRUE) {
  //   $deletesql = "DELETE FROM `cashfree_payment` WHERE order_id='".$order_id."'"; 
  //   $con->query($deletesql);
  //   } else {
