                ...
                <div class="col-md-6 align-self-center mt-smc-2">
                    ...
                    <ul class="lst-0 circle ps-0">
                        <li><i class="fa fa-check me-2"></i> <a class="text-blue-c"
                                href="{{ url('/book-editorial-services') }}">Editorial
                                Services</a></li>
                        <li><i class="fa fa-check me-2 "></i> <a
                                class="text-blue-c"href="{{ url('/book-designing-services') }}">Designing
                                Services</a></li>
                        <li><i class="fa fa-check me-2"></i> <a
                                class="text-blue-c"href="{{ url('/book-marketing-services') }}">Marketing
                                Services</a></li>
                        <li><i class="fa fa-check me-2"></i> <a
                                class="text-blue-c"href="{{ url('/book-distribution-services') }}">Distribution
                                Services</a></li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <img class="img-fluid rounded" src="{{ url('assets/img/other/our services.webp') }}" alt=""
                        srcset="">
                </div>
            </div>
