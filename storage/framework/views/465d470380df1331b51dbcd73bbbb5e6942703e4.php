...
<script>
    ...
    <?php echo $__env->yieldContent('extern-css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(url('assets/css/video-popup.css')); ?>">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css" />
    <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
    <link rel="stylesheet" href="<?php echo e(url('assets/gallery/style.css')); ?>">
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css" />
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.green.min.css" />
    <script>
        var host = "<?php echo e(url('')); ?>";
    </script>
    <style>
        .toast-error {
...
<noscript>
    ...
    <nav class="custom-shadow navbar navbar-expand-xl navbar-light sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand logo-wrapper" href="<?php echo e(url('/')); ?>">
    <img src="<?php echo e(url('assets/img/logo/bfc-logo.png')); ?>" alt="logo" class="img-fluid logo" />
</a>
            ...
            <ul class="navbar-nav main-menu ms-auto " id="menu">
                    ...
                    <li class="menu_has_children"><a href="#">Packages</a>
                        <ul class="sub-menu lst-0">
                            ...
                            <li><a href="<?php echo e(url('/paperback-publishing-packages')); ?>">Paperback</a></li>
                            <li><a href="<?php echo e(url('/ebook-publishing-packages')); ?>">eBook</a></li>
                        </ul>
                    </li>

                    <li class="menu_has_children"><a class="<?php echo e(request()->is('services') ? 'active' : ''); ?>"
                            href="<?php echo e('/services'); ?>">Services</a>
                        <ul class="sub-menu lst-0">
                            <li><a href="<?php echo e(url('/book-editorial-services')); ?>"> Editorial Services</a></li>
                            <li><a href="<?php echo e(url('/book-designing-services')); ?>">Designing Services</a></li>
                            <li><a href="<?php echo e(url('/book-marketing-services')); ?>">Marketing
                                    Services</a></li>
                            <li><a href="<?php echo e(url('/book-distribution-services')); ?>"> Distribution Services</a></li>
                            <li><a href="<?php echo e(url('/author-support')); ?>"> Author Support</a></li>
                        </ul>
                    </li>
                    <li><a class="<?php echo e(request()->is('royalty-calculator') ? 'active' : ''); ?>"
                            href="<?php echo e(url('/royalty-calculator')); ?>">Royalty Calculator</a></li>
            ...
            <div class="container">
                <div class="row pt-5 footer">
                    <div class="col-lg-3 col-md-6">
                        <div class="mt-n20"> <img src="<?php echo e(url('assets/img/logo/bfc-logo.png')); ?>" alt='logo'
                    ...
                    <ul class="col-lg-2 col-md-6 foot-link">
                        ...
                        <li> <a href="<?php echo e(url('/book-editorial-services')); ?>"><i class="fas fa-angle-right"></i>
                                Editorial Services</a>
                        </li>
                        <li> <a href="<?php echo e(url('/book-designing-services')); ?>"><i class="fas fa-angle-right"></i>
                                Designing
                                Services</a></li>
                        <li> <a href="<?php echo e(url('/book-marketing-services')); ?>"><i class="fas fa-angle-right"></i>
                                Marketing
                                Services</a></li>
                        <li> <a href="<?php echo e(url('/book-distribution-services')); ?>"><i
                                    class="fas fa-angle-right"></i> Distribution
                                Services</a></li>
                        <li> <a href="<?php echo e(url('/author-support')); ?>"><i class="fas fa-angle-right"></i>
                                Author Support</a></li>
                    </ul>
                    <ul class="col-lg-2 col-md-6 foot-link">
                        <li>
                        ...
                        <li> <a href="<?php echo e(url('/ebook-publishing-packages')); ?>"><i class="fas fa-angle-right"></i> Packages</a>
                        </li>
                        <li> <a href="<?php echo e('/services'); ?>"><i class="fas fa-angle-right"></i> Services</a></li>
                        <li> <a href="<?php echo e(url('/ebook-publisher-in-india')); ?>"><i class="fas fa-angle-right"></i> eBook
                                Publisher</a></li>
                        <li> <a href="<?php echo e(url('/book-publisher-in-india')); ?>"><i class="fas fa-angle-right"></i> Book
                                Publisher</a></li>
                    ...
                    <ul class="col-lg-2 col-md-6 foot-link mt-lg-2 pt-lg-1">
                        ...
                        <li> <a href="<?php echo e(url('/career')); ?>"><i class="fas fa-angle-right"></i> Career</a></li>
                        <!-- <li> <a href="<?php echo e(url('/royalty-calculator')); ?>"><i class="fas fa-angle-right"></i> Royalty
                                Calculator</a></li> -->
                        <li> <a href="<?php echo e(url('/print-on-demand-book-publishing')); ?>"><i class="fas fa-angle-right"></i> Print On
                                Demand</a></li>
                        <li> <a href="<?php echo e(url('/faq')); ?>"><i class="fas fa-angle-right"></i> FAQs</a></li>
                        <li><a class="<?php echo e(request()->is('contact') ? 'active' : ''); ?>" href="<?php echo e(url('/contact')); ?>"> <i class="fas fa-angle-right"></i>Contact
                            Us</a></li>
                    </ul>
            ...
            <section class="copyright">
                <div class="row">
                    ...
                    <div class="col-md-8 text-end">
                        <p>
                            <a href="<?php echo e(url('/terms-and-condition')); ?>">Terms and Conditions</a>
                            <span class="text-white"> | </span>
                            <a href="<?php echo e(url('/privacy-policy')); ?>">Privacy Policy</a>
                            <span class="text-white"> | </span>
                            <a href="<?php echo e(url('/legal-disclaimer')); ?>"> Legal Disclaimer</a>
                            <span class="text-white"> | </span>
                            <a href="<?php echo e('/refund-and-cancellation-policy'); ?>">Refund and Cancellation Policy</a>
                        </p>
    ...
    <script src="<?php echo e(url('assets/js/videos.js')); ?>"></script>
    <script src="<?php echo e(url('assets/gallery/script.js')); ?>"></script>
    <script>
        AOS.init();
    </script>
    <script src="<?php echo e(url('customjs/jquery.validate.min.js')); ?>"></script>
    <script src="<?php echo e(url('customjs/home.js')); ?>"></script>
    <?php echo $__env->yieldContent('extern-js'); ?>
    <script>
        $(document).ready(function() {
...
<?php /**PATH D:\xampp\htdocs\bfcpub\resources\views/layout/template.blade.php ENDPATH**/ ?>