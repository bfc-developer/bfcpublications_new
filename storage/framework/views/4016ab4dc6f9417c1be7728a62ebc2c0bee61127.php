            ...
            <div class="row align-items-center py-2 flex-wrap-reverse">
                <div class="col-md-6">
                    ...
                    <p class="text-justify">
                        ...
                        can be availed by an author looking to get <a href="<?php echo e(url('/')); ?>"
                ...
                <div class="col-md-6">
                    <div class="img-box1">
                        <div class="img1"><img src="<?php echo e(url('assets/img/other/print-on-demand.webp')); ?>" alt="Print-on-Demand Book publishing"
                                class="img-fluid" /></div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bfcpublications/public_html/resources/views/print-on-demand.blade.php ENDPATH**/ ?>