        ...
        <div class="container">
            ...
            <div class="row align-items-stretch py-5 flex-wrap-reverse">
                ...
                <div class="col-12 col-md-6 ">
                    <img class="img-fluid rounded" src="<?php echo e(url('assets/img/other/1.webp')); ?>" alt="" srcset="">
                </div>
    ...
    <section class="bg-light-blue">
        <div class="container">
            <div class="row align-items-stretch py-5">
                <div class="col-12 col-md-6 ">
                    <img class="img-fluid rounded" src="<?php echo e(url('assets/img/other/2.webp')); ?>" alt="" srcset="">
                </div>
                <div class="col-12 col-md-6  align-self-center mt-smc-2">
    ...
    <section class="">
        <div class="container">
            ...
            <div class="row align-items-stretch py-5 flex-wrap-reverse">
                ...
                <div class="col-12 col-md-6 ">
                    <img class="img-fluid rounded" src="<?php echo e(url('assets/img/other/3.webp')); ?>" alt="" srcset="">
                </div>
...
<?php $__env->startSection('extern-js'); ?>
    <script src="<?php echo e(url('customjs/mail.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bfcpublications/public_html/resources/views/career.blade.php ENDPATH**/ ?>