					...
					<div class="row justify-content-center center">
						<div class="col-md-12 custom-shodow">
							...
							<div class="payment-form pt-30">
								<form  action="<?php echo e(url('/create-payment')); ?>" method="POST" id="paymentform">
									<?php echo csrf_field(); ?>
									<div class="form-row"> 
										...
										<div class="form-group col-md-6">
											...
											<select id="inputState" class="form-control" name="state">
												...
												<?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($stes->name); ?>"><?php echo e($stes->name); ?></option>
...
</html><?php /**PATH /home/bfcpublications/public_html/resources/views/payment/payment_detail.blade.php ENDPATH**/ ?>