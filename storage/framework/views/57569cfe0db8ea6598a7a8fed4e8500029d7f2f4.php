        ...
        <div class="container">
            ...
            <div class="row align-items-stretch flex-wrap-reverse">
                ...
                <div class="col-12 col-md-6 ">
                    <img class="img-fluid" src="<?php echo e(url('assets/img/service/format editing.webp')); ?>" alt=""
                        srcset="">
                </div>
    ...
    <section class="bg-light-blue">
        <div class="container">
            <div class="row align-items-stretch">
                <div class="col-12 col-md-6 ">
                    <img class="img-fluid" src="<?php echo e(url('assets/img/service/proofreading.webp')); ?>" alt=""
                        srcset="">
                </div>
                <div class="col-12 col-md-6  align-self-center">
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bfcpublications/public_html/resources/views/editorial_services.blade.php ENDPATH**/ ?>