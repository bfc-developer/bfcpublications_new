    ...
    ?>
        <p class="text-center text-success" style="font-size: 18px;">
         Payment Details
            ...
            <div class="col-md-6 col-sm-6 col">Payment Status </div>
            <div class="col-md-6 col-sm-6 col  text-right"> 
            <strong><?php echo e($payment_status); ?></strong>
                                    </div> </div>
           <div class="row item-row sub-total-row">
            ...
            <strong><?php echo $order_id;?></strong>
                                    ...
                                    <div class="row item-row sub-total-row">
            <div class="col-md-6 col-sm-6 col">Order Amount  </div>
            <div class="col-md-6 col-sm-6 col  text-right">
            <strong><?php echo $order_amount;?></strong>
                                    </div> </div>
        ...
        <p class="text-center text-red">
          Payment is <?php echo e($payment_status); ?>.
          <br>
...
<?php
 ...
 ?><?php /**PATH /home/bfcpublications/public_html/resources/views/payment/payment-status.blade.php ENDPATH**/ ?>