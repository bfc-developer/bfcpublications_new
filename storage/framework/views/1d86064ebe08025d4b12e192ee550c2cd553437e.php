                                ...
                                <div class="col-md-6">
                                    <div class="d-flex inputf transcard">
                                        <select id="book_size" class="form-select" aria-label="Default select example">
                                            ...
                                            <?php $__currentLoopData = $book_size; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->booksize); ?>"><?php echo e($value->booksize); ?></option>
...
<?php $__env->startSection('extern-js'); ?>
    <script src="<?php echo e(url('customjs/royalty_calculator.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bfcpublications/public_html/resources/views/royalty-calculator.blade.php ENDPATH**/ ?>