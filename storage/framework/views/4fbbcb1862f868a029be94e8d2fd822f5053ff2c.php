    ...
    <section class="editorial pb-2">
        <div class="container">
            ...
            <div class="row align-items-stretch py-5 flex-wrap-reverse">
                ...
                <div class="col-md-6">
                    <img class="img-fluid" src="<?php echo e(url('assets/img/other/process.webp')); ?>" alt="" srcset="">
                </div>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bfcpublications/public_html/resources/views/process.blade.php ENDPATH**/ ?>