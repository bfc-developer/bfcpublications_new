    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="portfolio-title text-center pb-2">
                <h2 class="text-uppercase">BFC Publications Podcast</h2>
            </div>
        </div>
    </div>
                ...
                <div>
                    <div class="row">
                        <div class="col-md-6 pb-3 ">
                            <a href="{{ url('/book-stall') }}" class="ba">
                                <span>
                                    <div class="klf-link d-flex klf-icon_box align-items-stretch">
                                        <img src="{{ url('assets/img/klf/books.webp') }}" class="img-fluid" />
                        ...
                        <div class="col-md-6 pb-3">
                            <a href="{{ url('/bfc-lounge') }}" class="ba">
                                <span>
                                    <div class="klf-link d-flex">
                                        <img src="{{ url('assets/img/klf/lounge.webp') }}" class="img-fluid" />
                                        <p>BFC Lounge</p>
                                    </div>
                                </span>
                            </a>
                        ...
                        <div class="col-md-6">
                            <a href="{{ url('/sessions-klf') }}" class="ba">
                                <span>
                                    <div class="klf-link d-flex">
                                        <img src="{{ url('assets/img/klf/interview.webp') }}" class="img-fluid" />
                                        <p>KLF Sessions</p>
                                    </div>
                                </span>
                            </a>
                        ...
                        <div class="col-md-6 ">
                            ...
                            <a href="{{ url('/gallery') }}" class="ba">
                                <span>
                                    <div class="klf-link d-flex">
                                        <img src="{{ url('assets/img/klf/image-gallery.webp') }}" class="img-fluid" />
                                        <p>Gallery</p>
                                    </div>
                                </span>
                            </a>
    ...
    <div class="container">
        ...
        <div class="row py-5">
                        ...
                        <div class="card-img">
                            <div class="flip-card-inner ">
                                <div class="flip-card-front p-2">
                                    <img src="{{ url('assets/img/home/about_2_3.webp') }}" alt="" />
                                </div>
                ...
                <a href="{{ url('/book-designing-services') }}">
                    <div class="card border-0">
                        <div class="card-img">
                            <div class="flip-card-inner">
                                <div class="flip-card-front p-2">
                                    <img src="{{ url('assets/img/other/designing.webp') }}" alt="" />
                                </div>
                                <div class="flip-card-back p-3">
                ...
                <a href="{{ url('/book-marketing-services') }}">
                    <div class="card border-0">
                        <div class="card-img">
                            <div class="flip-card-inner">
                                <div class="flip-card-front p-2">
                                    <img src="{{ url('assets/img/home/marketing.webp') }}" alt="" />
                                </div>
                                <div class="flip-card-back p-3">
                ...
                <a href="{{ url('/book-distribution-services') }}">
                    <div class="card border-0">
                        <div class="card-img">
                            <div class="flip-card-inner">
                                <div class="flip-card-front p-2">
                                    <img src="{{ url('assets/img/home/distribution.webp') }}" alt="" />
                                </div>
                                <div class="flip-card-back p-3">
                ...
                <a href="{{ url('/author-support') }}">
                    <div class="card border-0 ">
                        <div class="card-img ">
                            <div class="flip-card-inner">
                                <div class="flip-card-front p-2">
                                    <img src="{{ url('assets/img/home/as.webp') }}" alt="" />
                                </div>
                                <div class="flip-card-back p-3">
                ...
                <a href="{{ '/legal' }}">
                    <div class="card border-0 ">
                        <div class="card-img ">
                            <div class="flip-card-inner">
                                <div class="flip-card-front p-2">
                                    <img src="{{ url('assets/img/other/AGREEMENT.webp') }}" alt="" />
                                </div>
                                <div class="flip-card-back p-3">
            ...
            <div class="col-md-12 text-center pt-4">
                <a href="{{ url('/services') }}" class="btn btn-custom"> Explore More</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row py-5">
            <div class="col-md-12">
                <div class="main-timeline">
                    <div class="timeline">
                        <a href="{{ url('/process') }}" class="timeline-content tc-1">
                    ...
                    <div class="timeline">
                        <a href="{{ url('/process') }}" class="timeline-content tc-2">
                    ...
                    <div class="timeline">
                        <a href="{{ url('/process') }}" class="timeline-content tc-3">
                    ...
                    <div class="timeline">
                        <a href="{{ url('/book-editorial-services') }}" class="timeline-content tc-4">
                    ...
                    <div class="timeline">
                        <a href="{{ url('/book-designing-services') }}" class="timeline-content tc-1">
                    ...
                    <div class="timeline">
                        <a href="{{ url('/book-marketing-services') }}" class="timeline-content tc-2">
                            <div class="timeline-icon"><img src="{{ url('assets/img/matrix/social-media.png') }}"
                    ...
                    <div class="timeline">
                        <a href="{{ url('/royalty-calculator') }}" class="timeline-content tc-3">
...
<section class="pt-4">
    <div class="container">
        <h1 class="headm">WHY BFC Publication is The Best Self-Book Publisher In India</h1>
        <div class="space">
            <div class="row align-items-stretch">
                <div class="col-md-6 mt-smc-2">
                ...
                <div class="col-md-6  pt-5 mt-2 align-self-center">
                    ...
                    <div class="col-md-12  pt-4 mb-5">
                        <a href="{{ url('/why-us') }}" class="btn btn-custom"> Explore More</a>
                    </div>
                    <div class="animate__animated animate__fadeIn animate__delay-0.2s">
                        <img src="{{ url('assets/img/home/2.png') }}" alt="" class="img-fluid why-img-c" />
                    </div>
                </div>
            </div>
        </div>
...
<div class="qr-d-flex pb-5 pt-3">
    <div class="qr-body-container">
        <div class="bhim-upi">
            <img src="{{ url('assets/payment_image/bhim-upi.jpeg') }}" alt="">
        </div>
        <div class="bfc-publication-name">
            <h2>BFC PUBLICATION PVT LTD</h2>
        </div>
        <div class="qr-image">
            <img src="{{ url('assets/payment_image/qr-code.png') }}" alt="">
        </div>
    ...
    <div class="bank-body-container">
        <div class="text-center">
            <h2 style="font-size: 25px !important;padding-bottom: 8px !important;">Account Details</h2>
        </div>
...
<div tabindex="-1" id="start-pub"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" id="lead_id">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-search mb-3">
                                ...
                                <span class="text-danger" id="manuscript_status_err"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group has-search mb-3">
                                ...
                                <span class="text-danger" id="book_earlier_err"></span>
                            </div>
                        </div>
