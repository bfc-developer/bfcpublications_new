...
// $tablenames='cashfree_payment';
// $sq1l="UPDATE `".$tablename."` SET `payment_status`='".$orderStatus."',`payment_time`='".$payment_time."',`callback_response`='".$input."' where `order_id`='".$orderid."'";
// if ($con->query($sq1l) === TRUE) {
//  echo "New record created successfully"; 
// } else {
//  echo "Error: " . $sql . "<br>" . $conn->error; die;
// }
